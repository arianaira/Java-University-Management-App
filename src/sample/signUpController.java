...
public class signUpController
{
    ...
    void signUpRoled(ActionEvent event) throws IOException
    {
        ...
        {
            Parent studentSignUp = FXMLLoader.load(getClass().getResource("studentSignUp.fxml"));
        ...
        {
            Parent professorSignUp = FXMLLoader.load(getClass().getResource("professorSignUp.fxml"));
